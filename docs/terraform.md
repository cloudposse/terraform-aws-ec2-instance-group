...
| <a name="input_ebs_iops"></a> [ebs\_iops](#input\_ebs\_iops) | Amount of provisioned IOPS. This must be set with a volume\_type of io1 or gp3 | `number` | `0` | no |
...
| <a name="input_ebs_throughput"></a> [ebs\_throughput](#input\_ebs\_throughput) | Throughput to provision for the EBS volumes in mebibytes per second (MiB/s). This must be set if ebs\_volume\_type is set to `gp3` | `number` | `0` | no |
...
| <a name="input_ebs_volume_type"></a> [ebs\_volume\_type](#input\_ebs\_volume\_type) | The type of EBS volume. Can be standard, gp2, gp3 or io1 | `string` | `"gp2"` | no |
| <a name="input_enable_ssh_key_pair"></a> [enable\_ssh\_key\_pair](#input\_enable\_ssh\_key\_pair) | If false, no key pair will be attached to the instances | `bool` | `true` | no |
...
| <a name="input_root_iops"></a> [root\_iops](#input\_root\_iops) | Amount of provisioned IOPS. This must be set if root\_volume\_type is set to `io1` or `gp3` | `number` | `0` | no |
| <a name="input_root_throughput"></a> [root\_throughput](#input\_root\_throughput) | Throughput to provision for the root volume in mebibytes per second (MiB/s). This must be set if root\_volume\_type is set to `gp3` | `number` | `0` | no |
...
| <a name="input_root_volume_type"></a> [root\_volume\_type](#input\_root\_volume\_type) | Type of root volume. Can be standard, gp2, gp3 or io1 | `string` | `"gp2"` | no |
